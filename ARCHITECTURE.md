...
- Todo projeto precisará respeitar as regras de Lint escritas no arquivo app: [Geral](app/analysis_options.yaml) backend: [Geral](backend/analysis_options.yaml).
